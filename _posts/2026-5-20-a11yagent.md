...
We coded the posts for the nature of questions asked and for the features the queries were about. These queries were further used to test the agent in the building stage. The graph below shows our analysis using the feature codes. 
...
<figure style="margin: 0; display: grid; justify-items: center; gap: 6px; justify-self: center;">
  ...
  <figcaption style="font-size: 0.8em; line-height: 1.2; text-align: center; padding: 4px;">Distribution of program-l queries for different VS Code features (January 2021 to December 2025).</figcaption>
</figure>
<br>

The forum posts indicated several discoverability challenges faced by users. The kind of questions they asked indicated that they felt overwhelmed by the abundance of features and their evolving behavior and were unsure about which features met their specific requirements, if any. Users frequently asked about the use of specific features, the keybindings required to complete particular workflows, and reported issues encountered in trying out features. Queries were more frequent for some features like the Editor, Terminal, and Sound cues.
...
## Start Using a11yagent
a11yagent can be installed from the Visual Studio Code marketplace: [a11yagent](https://marketplace.visualstudio.com/items?itemName=IDEA.a11yagent).
